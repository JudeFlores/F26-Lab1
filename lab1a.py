...
# Create a variable called `x` and assign it the value 10, then print the type of this variable.
x = 10
print(type(x))
...
x = "This used to be a number"
print(type(x))
"""I saw that x used to be an integer, but now it is a string because of dynamic typing"""